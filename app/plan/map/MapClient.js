...
export default function MapClient({ focus }) {
  const focusedStopId = typeof focus === "string" && focus.length > 0 ? focus : undefined;
        ...
        <div className="relative my-2 rounded-3xl border border-white/50 bg-white/70 p-3 shadow-[0_18px_50px_rgba(15,23,42,0.14)] backdrop-blur">
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="mt-1 text-xs text-slate-600">ETA 6h 45m • 430 mi • Depart 9:30 AM</div>
            </div>
              ...
              <ListItem>
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1 text-xs text-slate-500">+0 min detour • Arrive 9:52 • Charge 18 min</div>
                  </div>
              ...
              <ListItem>
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1 text-xs text-slate-500">+8 min detour • Arrive 12:18 • Charge 22 min</div>
                  </div>
                  <div className="rounded-full bg-brand-red/10 px-3 py-1 text-[11px] font-semibold text-brand-red">
                    Stop
                  </div>
